...
if(isset($_SESSION["idusuario"])){
  ...
  $datos=$usuario->get_categoria();  // llamamos al metodo get_ususario de userModulo
  ?>
   ...
   <br><br> <br><br>
            <div class="panel panel-default">
                        <div class="panel-heading">
                          <h3 >CATEGORIA DE LOS ARTICULOS</h3>
                            <?php
   if(isset($_GET['mar'])){
    switch ($_GET['mar']){
      case '1':
...
<?php  
  ...
  ?>
                            ...
                            <div class="panel-body">
                                  <table class="table" id="myTable">
                                    ...
                                    <tbody>
                                      <?php for ($i=0; $i <sizeof($datos); $i++) { // instancie dato de clasePrograma
                                       ?>
                                      <tr>
                                        <td><?php echo $datos[$i]["idcategoria"] ?></td>
                                        <td><?php echo $datos[$i]["nombre"] ?></td>
                                       

                                        <td><a class="btn btn-success" href="<?php echo Conectar::ruta();?>EditarCategoria.php?idusuario=<?php echo $datos[$i]["idcategoria"];?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"> </span> Editar</a> <a class="btn btn-danger" href="<?php echo Conectar::ruta();?>EliminarCategoria.php?idusuario=<?php echo $datos[$i]["idcategoria"];?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Eliminar</a></td> 
                                        </tr>
                                      <?php }?>
                                    </tbody>
                                  </table>
                                  ...
                                  <center>
                                  <a href="AgregarCategoria.php"><button class="btn btn-info">Agregar Categoria</button></a>
                                  </center>
                                </div>
                        </div>
