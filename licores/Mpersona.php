...
if(isset($_SESSION["idusuario"])){
  ...
  $datos=$usuario->get_persona();  // llamamos al metodo get_ususario de userModulo
  ?>
    ...
    switch ($_GET['mar']){
      case '1':
        ...
        <div class="alert alert-danger">
         <strong>EXITOSO</strong>  ELIMINADO PERSONA
        </div>
        <?php 
        break;
    }
...
<?php  
    ...
    switch ($_GET['m']){
      case '1':
        ?>
        <div class="alert alert-danger">
         <strong>ERROR AL EDITAR PERSONA </strong>  CAMPO VACIO
        </div>
        <?php 
        break;
         case '2':
  ...
  ?>
                            ...
                            <div class="panel-body">
                                  <table class="table" id="myTable">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td><?php echo $datos[$i]["tipodepersona"] ?></td>
                                        ...
                                        <td><a class="btn btn-success" href="EditarPersona.php?idusuario=<?php echo $datos[$i]["idpersona"];?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"> </span> Editar</a> <a class="btn btn-danger" href="<?php echo Conectar::ruta();?>EliminarPersona.php?idusuario=<?php echo $datos[$i]["idpersona"];?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Eliminar</a></td> 
                                        </tr>
                                      <?php }?>
                                    </tbody>
                                  </table>
                                  ...
                                  <center>
                                  <a href="AgregarPersona.php"><button class="btn btn-info">Agregar Persona</button></a>
                                  </center>
                                </div>
                        </div>
