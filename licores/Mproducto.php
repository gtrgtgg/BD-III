...
if(isset($_SESSION["idusuario"])){
  ...
  $datos=$usuario->get_producto();  // llamamos al metodo get_ususario de userModulo
  ?>
    ...
    switch ($_GET['mar']){
      case '1':
        ...
        <div class="alert alert-danger">
         <strong>EXITOSO</strong>  ELIMINADO ARTICULO
        </div>
        <?php 
        break;
    }
...
<?php  
    ...
    switch ($_GET['m']){
      case '1':
        ?>
        <div class="alert alert-danger">
         <strong>ERROR AL EDITAR ARTICULO </strong>  CAMPO VACIO
        </div>
        <?php 
        break;
         case '2':
        ...
        <div class="alert alert-success">
         <strong>EXITOSO  </strong>  ARTICULO
        </div>
        <?php 
        break;
    }
  ...
  ?>
                            ...
                            <div class="panel-body">
                                  <table class="table" id="myTable">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td><a class="btn btn-success" href="<?php echo Conectar::ruta();?>EditarProducto.php?idusuario=<?php echo $datos[$i]["idproducto"];?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"> </span> Editar</a> <a class="btn btn-danger" href="<?php echo Conectar::ruta();?>EliminarProducto.php?idusuario=<?php echo $datos[$i]["idproducto"];?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Eliminar</a></td> 
                                        </tr>
                                      <?php }?>
                                    </tbody>
                                  </table>
                                  ...
                                  <center>
                                  <a href="AgregarArticulo.php"><button class="btn btn-info">Agregar Articulo</button></a>
                                  </center>
                                </div>
                        </div>
