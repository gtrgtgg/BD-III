 ...
 if(isset($_SESSION["idusuario"])){
  require_once("Clases/usuarios.php"); 
    $usuario= new Usuario();
      ...
      $datos=$usuario->get_categoria(); 

  if(isset($_POST["grabar"]) and $_POST["grabar"]=="si"){   
    $usuario->AgregarArticulo();
    exit();
 }
  ?>
...
<body>
   ...
   if(isset($_GET['m'])){
    switch ($_GET['m']){
      ...
      case '2':
        ...
        <strong>Exitoso!</strong> Articulo Ingresado Exitosamente
         </div> 
        <?php
        break;
         case '3':
  ...
  ?>
               ...
               <select name="idcategoria" class="form-control" >
                  ...
                  <?php 
                                     for($i=0; $i<sizeof($datos); $i++) { 
                                      ?>
                                        <option value="<?php echo $datos[$i]["idcategoria"]; ?>"> <?php echo $datos[$i]["nombre"]; ?> </option>
                                       <?php
                                     }
                  ?>
              ...
              <div class="col-sm-6">
                <input type="number" name="stock" class="form-control" placeholder="Ingrese stock Del Producto">
              </div>
                </div>
           ...
           <center>
              <button type="submit"  class="bbtn btn-primary">REGISTRAR ARTICULO</button>
                   </center>       
                          </form>
