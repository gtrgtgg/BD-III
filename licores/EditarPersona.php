<?php
 ...
 require_once("Clases/conexion.php");
  ...
  if(isset($_SESSION["idusuario"])){
    ...
    $datos=$usuario->get_persona_por_id($_GET["idusuario"]);
 
    if(isset($_POST["grabar"]) and $_POST["grabar"]=="si"){
       
      $usuario->editar_persona();
       exit();
    }
...
<body>
  ...
  <footer>
    ...
    <h1>Editar Persona</h1>
              ...
              <div class="col-sm-6">
                <input type="number" name="telefono" class="form-control" placeholder="Telefono" value="<?php echo $datos[0]["telefono"];?>">
              </div>
                </div>
              </div>
              ...
              <div class="col-sm-6">
                <input type="text" name="direccion" class="form-control" placeholder="ingrese Direccion" value="<?php echo $datos[0]["direccion"];?>">
              </div>
                </div>
              </div>
              ...
              <div class="col-sm-6">
                <input type="email" name="gmail" class="form-control" placeholder="Correo Electronico" value="<?php echo $datos[0]["gmail"];?>" >
              </div>
                </div>
              </div>
           ...
           <center>
              <button type="submit"  class="bbtn btn-primary">ACTUALIZAR PERSONA</button>
                   </center>       
                          </form>
