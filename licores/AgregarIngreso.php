...
<!-- este es la hoja de estilo de booctrac para seleccionar-->
  ...
  <div class="panel panel-default"> <!--este es mi formulario el cuAL VAN TODOS MIS CAMPOS-->
    <div class="panel-heading" > <!--Para el titulo-->
      <h3 class="panel-title" ><span class="glyphicon glyphicon-user" aria-hidden="true" style="background-color:#54EDE2"> </span>  Ingreso de Articulo</h3>
    </div>
    ...
    switch ($_GET['m']){
      case '1':
        ...
        <div class="alert alert-danger">
         <strong>ERROR</strong>  AL INGRESAR EL PRODUCTO
        </div>
        <?php 
        break;
         case '2':
        ...
        <div class="alert alert-success">
         <strong>EXITOSO</strong>  PRODUCTO INGRESADO CON EXITO
        </div>
        <?php 
        break;
    }
...
<div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
<div class="form-group">
<label for="cantidad">Precio compra: </label> <br>
<input type="number" name="pprecio_compra" id="pprecio_compra" class="form-group" placeholder="P. compra $"> 
</div>
</div>
...
<button type="button" id="bt_add" class="btn btn-primary" style="background-color:#36CA3C">Agregar</button> 
</div>
</div>

<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12"></div>
<table  id="detalles" class="table table-striped table-bordered table-condensed table-hover">
  <thead style="background-color:#54EDE2">
    <th>Opciones</th>
    <th>Articulo</th>
    <th>Cantidad</th>
    <th>Precio Compra</th>
...
var fila='<tr class="selected" id="fila'+cont+'"> <td> <button type="button" class="btn btn-warning"  onClick="eliminar('+cont+'); ">X</td>   <td><input type="hidden" name="idarticulo[]" value="'+idarticulo+'" > '+articulo+' </td>   <td><input type="number" name="cantida[]" value="'+cantidad+'"></td>        <td><input type="number" name="precio_compra[]" value="'+precio_compra+'" ></td>     <td><input type="number" name="precio_venta[]" value="'+precio_venta+'" ></td>      <td>'+subtotal[cont]+' </td>       </tr>';
cont++;
