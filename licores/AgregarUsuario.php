...
<body>
   ...
   if(isset($_GET['m'])){
    switch ($_GET['m']){
      ...
      case '2':
        ...
        <strong>Exitoso!</strong> Usuario Ingresado Exitosamente
         </div> 
        <?php
        break;
         case '3':
  ...
  ?>
              ...
              <div class="col-sm-6">
                <input type="number" name="cedula" class="form-control" placeholder="Ingrese Cedula" required>
              </div>
                </div>
              </div>
              ...
              <div class="col-sm-6">
                <input type="text" name="user" class="form-control" placeholder="example@gmail,com" required>
              </div>
                </div>
              </div>
              ...
              <div class="col-sm-6">
                <input type="password" name="contracena" class="form-control" placeholder="ingrese contraseña" required>
              </div>
                </div>
              </div>
              ...
              <div class="col-sm-6">
                <input type="password" name="confirmar" class="form-control" placeholder="Confirmar La Contraseña" required>
              </div>
                </div>
              </div>
           ...
           <center>
              <button type="submit"  class="bbtn btn-primary">REGISTRAR USUARIO</button>
                   </center>
                          </form>
